	...
	<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
		...
		<div class="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden">
			<div class="flex items-center justify-between px-5 py-4 border-b border-slate-800">
				...
				<a href="/portal/vendor/bids" class="text-xs text-orange-400 hover:underline">View all →</a>
			</div>
			{#if bids.length === 0}
				<div class="px-5 py-10 text-center">
					<FileText class="size-8 text-slate-700 mx-auto mb-3" />
					<p class="text-sm text-slate-500">No bids submitted yet.</p>
					<a href="/portal/vendor/projects" class="mt-2 inline-flex items-center gap-1 text-xs text-orange-400 hover:underline">
		...
		<div class="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden">
			<div class="flex items-center justify-between px-5 py-4 border-b border-slate-800">
				...
				<a href="/portal/vendor/projects" class="text-xs text-orange-400 hover:underline">View all →</a>
			</div>
			...
			{:else}
				<div class="divide-y divide-slate-800">
					{#each openProjects.slice(0, 5) as project}
						<a href="/portal/vendor/projects/{project.id}"
