...
export const ROLE_MENU_CONTROL_ITEMS: RoleMenuItem[] = [
	...
	{ title: 'Start Project', url: '/dashboard/projects' },
	...
	{ title: 'Start Event', url: '/dashboard/events/new' },
	{ title: 'Import Data', url: '/dashboard/import' },
	{ title: 'Media', url: '/dashboard/media' },
	{ title: 'Start Media Content', url: '/dashboard/content' },
	...
	{ title: 'Start Campaign', url: '/dashboard/marketing/campaigns/new' },
...
const ENABLED_BY_DEFAULT: Record<string, RoleMenuControlRole[]> = {
	...
	'/dashboard/projects': ['leader', 'marketing_lead'],
	...
	'/dashboard/marketing/campaigns/new': ['leader', 'marketing', 'marketing_lead'],
