<script lang="ts">
	...
	const variantClasses = {
		folder: {
			...
			tab: 'px-3 py-2 rounded-t-lg font-medium text-sm transition-all relative cursor-pointer',
		...
		button: {
			...
			tab: 'px-3 py-1.5 rounded-lg font-medium text-sm transition-all border-2 cursor-pointer',
		...
		pill: {
			container: 'flex flex-wrap gap-1.5',
			tab: 'px-3 py-1.5 rounded-full font-medium text-sm transition-all cursor-pointer',
