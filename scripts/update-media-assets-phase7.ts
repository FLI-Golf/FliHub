...
async function updateMediaAssetsPhase7() {
	...
	for (const collectionName of PHASE7_COLLECTIONS) {
	...
	console.log('Phase 7 AI enrichment collections are ready.');
}

updateMediaAssetsPhase7().catch((error) => {
