...
const PHASE5_COLLECTIONS = [
	'media_collections',
	'highlight_packages',
	'highlight_package_items'
] as const;

async function updateMediaAssetsPhase5() {
	...
	console.log('Phase 5 highlight builder collections are ready.');
}

updateMediaAssetsPhase5().catch((error) => {
