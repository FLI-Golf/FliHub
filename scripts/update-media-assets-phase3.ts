...
async function updateMediaAssetsPhase3() {
	...
	for (const collectionName of PHASE3_COLLECTIONS) {
	...
	console.log('Phase 3 media rights and licensing collections are ready.');
}

updateMediaAssetsPhase3().catch((error) => {
