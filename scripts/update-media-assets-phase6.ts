...
async function updateMediaAssetsPhase6() {
	...
	for (const collectionName of PHASE6_COLLECTIONS) {
	...
	console.log('Phase 6 marketplace/archive/dashboard collections are ready.');
}

updateMediaAssetsPhase6().catch((error) => {
